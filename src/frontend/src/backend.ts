...
import type { Category as _Category, Shayari as _Shayari, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addShayari(arg0: string, arg1: string, arg2: Category): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addShayari(arg0, arg1, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLikedShayariIds(arg0: Principal): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLikedShayariIds(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRandomShayari(arg0: Category): Promise<Shayari | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getRandomShayari(to_candid_Category_n1(this._uploadFile, this._downloadFile, arg0));
    ...
    async getShayariByCategory(arg0: Category, arg1: bigint, arg2: bigint): Promise<Array<Shayari>> {
        if (this.processError) {
            try {
                const result = await this.actor.getShayariByCategory(to_candid_Category_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
    ...
    async getTrending(arg0: bigint, arg1: bigint): Promise<Array<Shayari>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrending(arg0, arg1);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeShayari(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeShayari(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchShayari(arg0: string): Promise<Array<Shayari>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchShayari(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlikeShayari(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlikeShayari(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Shayari_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Shayari): Shayari {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Shayari]): Shayari | null {
    return value.length === 0 ? null : from_candid_Shayari_n9(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "sad" in value ? Category.sad : "friendship" in value ? Category.friendship : "love" in value ? Category.love : "attitude" in value ? Category.attitude : "motivational" in value ? Category.motivational : value;
}
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Shayari>): Array<Shayari> {
    return value.map((x)=>from_candid_Shayari_n9(_uploadFile, _downloadFile, x));
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.sad ? {
        sad: null
    } : value == Category.friendship ? {
        friendship: null
    } : value == Category.love ? {
        love: null
    } : value == Category.attitude ? {
        attitude: null
